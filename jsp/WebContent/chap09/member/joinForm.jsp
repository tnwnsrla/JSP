		...
		<table>
			...
			<tr> <td>아이디</td>
				 <td><input type="text" name="userid" size="20" id="userid">* <input
						...
						value="중복 체크" onclick="idCheck()"></td></tr>
			<tr> <td>암 호</td>
				 <td><input type="password" name="pwd" size="20">*</td></tr>
			<tr height="30"> <td width="80">암호 확인</td>
			...
			<tr> <td>등급</td>
				 <td><input type="radio" id=”normal” name="grade" value="0" checked="checked">
				  <label for=”nomal”>일반회원</label>
				  <input type="radio" id=”admin” name="grade" value="1">
				   <label for=”admin”>관리자</label></td></tr>
